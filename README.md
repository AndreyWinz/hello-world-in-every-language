...
| (P™TM™)™ | 1 | No |  |  |
| (SIASL)² | 2 | Yes | C | Normal & Hex |
| (Visual) FoxPro | 1 | No |  |  |
| *><> | 1 | Yes | JavaScript & Golang |  |
| *lang | 1 | Yes | Python |  |
| ++C | 1 | No |  |  |
| ++brainfuck++ | 1 | Lisp |  |  |
| ++Ↄ | 1 | No |  |  |
...
| --yay | 1 | Yes | Python |  |
| -C++ | 1 | No |  |  |
| -Output | 2 | No |  | Normal & Alt |
| .((o)) | 1 | No |  |  |
| .: | 0 (Cannot be written before the execution of the program) | No (file maker present) | Python (file maker) |  |
| .chef | 1 | No |  |  |
| .easy | 1 | No |  |  |
| .gertrude | 1 | No |  |  |
| .yacuabll | 1 | No |  |  |
| ;) | 1 | No |  |  |
| ? (Ask, None-Ask) | 1 | Yes | Python |  |
| A# (.NET) | 1 | No |  |  |
| A-Frame | 1 | No |  |  |
| ABAP | 1 | No |  |  |
| AGSPL | 1 | No |  |  |
...
| Agda | 1 | No |  |  |
| Aldor | 1 | No |  |  |
| Algol | 2 | No |  | Algol 60 & Algol 68 |
| AmbientTalk | 1 | No |  |  |
| Amega E | 1 | No |  |  |
| AngularJS | 1 (consisting of 3 files) | No |  | Consists of 3 files: HTML; TS; JSON |
| Apex | 1 | No |  |  |
| AppleScript | 1 | No |  |  |
| Arc | 1 | No |  |  |
| ArkTS | 1 | No |  |  |
